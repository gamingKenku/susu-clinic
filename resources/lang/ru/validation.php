...
return [
    ...
    'attributes'           => [
        ...
        'end_time' => 'время конца работы',
        'end_time.0' => 'время конца работы в понедельник',
        'end_time.1' => 'время конца работы во вторник',
        'end_time.2' => 'время конца работы в среду',
        'end_time.3' => 'время конца работы в четверг',
        'end_time.4' => 'время конца работы в пятницу',
        'end_time.5' => 'время конца работы в субботу',
        'end_time.6' => 'время конца работы в воскресенье',
        'start_time' => 'время начала работы',
        'start_time.0' => 'время начала работы в понедельник',
        'start_time.1' => 'время начала работы во вторник',
        'start_time.2' => 'время начала работы в среду',
        'start_time.3' => 'время начала работы в четверг',
        'start_time.4' => 'время начала работы в пятницу',
        'start_time.5' => 'время начала работы в субботу',
        'start_time.6' => 'время начала работы в воскресенье',

...
<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9">
        <input class="form-control{{ $errors->has('document_path') ? ' is-invalid' : '' }}" name="document_path" type="text" id="document_path" value="{{ old('document_path', optional($document)->document_path) }}" minlength="1" maxlength="255" required="true" placeholder="Вставьте документ...">

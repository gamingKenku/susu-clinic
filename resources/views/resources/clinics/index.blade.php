                                ...
                                <td class="text-end">
                                    ...
                                    {{ csrf_field() }}
                                        ...
                                        <div class="btn-group btn-group-sm" role="group">
                                            <a href="{{ route('clinics.show', $clinics->id ) }}" class="btn btn-info" title="Показать">
                                                <span class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></span>
                                            </a>
                                            <a href="{{ route('clinics.edit', $clinics->id ) }}" class="btn btn-primary" title="Редактировать">
                                                <span class="fa-regular fa-pen-to-square" aria-hidden="true"></span>
                                            </a>
    
                                            <button type="submit" class="btn btn-danger" title="Удалить" onclick="return confirm(&quot;Click Ok to delete Clinics.&quot;)">
